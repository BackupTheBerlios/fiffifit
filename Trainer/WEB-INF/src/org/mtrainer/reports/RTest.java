 ...
 * @author  Guido Laures
 */
public class RTest implements DatasetProducer, CategoryToolTipGenerator, CategoryItemLinkGenerator, Serializable {
    ...
    private final String[] seriesNames =    {"Bycicle", "Jogging"};
    ...
    public Object produceDataset(Map params) throws DatasetProduceException {
        ...
        for (int series = 0; series < seriesNames.length; series ++) {
            int lastY = (int)(Math.random() * 30 + 200);
